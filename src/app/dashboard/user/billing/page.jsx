...
//   },
//   {
//     id: "price_1TkMLsAm4G5oPHojlcJOSv8N", // Pro
//     name: "Pro",
//     price: "$9.99",
//     limit: "9 paintings",
//     icon: FaCrown,
...
//   },
//   {
//     id: "price_1TkMMEAm4G5oPHojIirGBGvq", // Premium
//     name: "Premium",
//     price: "$19.99",
//     limit: "Unlimited",
//     icon: FaGem,
...
//         </h1>
//         <p className="text-slate-500">Upgrade your experience and expand your collection limits.</p>
//       </div>
...
//                 <div key={feat} className="flex items-center gap-2 text-slate-600 dark:text-slate-300">
//                   <FaCheck className="text-[#22C55E]" /> {feat}
//                 </div>
//               ))}
//             </div>
...
//                   : `bg-gradient-to-r ${plan.gradient} text-white hover:scale-[1.02] shadow-lg shadow-[#7C3AED]/20`
//               }`}
//             >
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4">
      <div className="text-center mb-12 space-y-3">
        <h1 className="text-4xl font-black text-slate-900 dark:text-white">
          Choose your{" "}
          <span className="text-[#7C3AED]">Artistic Tier</span>
        </h1>
